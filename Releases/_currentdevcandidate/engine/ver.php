<?php 
$pro_name = '🎶 Pan<span class="pangomfont text-danger">Play</span>';
$pro_name_noformat = '🎶 PanPlay';
$pro_version = '0.0.2.0a';
$pro_version_name = 'Barberry';
$pro_license = 'MIT-License';
$pro_license_url = 'https://www.tldrlegal.com/license/mit-license';
$pro_releasedate = '03.10.2024';
...
echo "</div><!--<div class='col-4'><img style ='margin: 0.2em;' class='rounded' src='rscs/imglibs/social/oop_orbs/oop-l-color.png' width='100%' height='auto' alt='PanPlay'></div>--></div></div>";
