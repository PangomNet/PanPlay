...
<img id="songcover" class="mx-auto d-block img-fluid" src="engine/extensions/baseaudio/placeholder-cover.png" style="width: min(640px, 100%); height: min(480px, 100%); cursor: hand;" alt="PanPlay">
<style>
