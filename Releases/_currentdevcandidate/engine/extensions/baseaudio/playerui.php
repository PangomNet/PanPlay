...
<img id="songcover" onclick="playPause()" class="mx-auto d-block img-fluid" src="engine/extensions/baseaudio/placeholder-cover.png" style="width: min(640px, 100%); height: min(480px, 100%); cursor: pointer;" alt="PanPlay">
<style>
...
function updateCurrentAlbumArtFromAPI() {
        ...
        currentAlbumArtUrl = "engine/extensions/baseaudio/bg.png";
    };
...
echo "<br><div id='currentsong_lbl' data-bs-toggle='modal' data-bs-target='#lastplayed_modal' style='animation-delay: 3s; animation-duration: 6.875s; cursor: pointer;' class='h3 d-flex justify-content-center text-container'><span id='currentsong_lbl_holder' class='text-center oop_title_label_meta oop_title_label_meta--song oop_title_label_meta--scroll' data-bs-toggle='tooltip' data-bs-placement='top' title='" . $webstream .  "'>" . $webstream . "<span></div>";
