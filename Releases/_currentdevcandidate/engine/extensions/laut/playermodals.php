...
<%= "<figure class='text-center'>
  <blockquote class='blockquote'>
    <p>" + this.format + "</blockquote>
  <figcaption class='blockquote-footer'>
  $lfmstream <cite title='Source Title'>@laut.fm</cite>
  </figcaption>
</figure>" %>
</script>
<script type="text/javascript" charset="utf-8">
...
.info({container:'api_lfm_format', template:'format_template'}, true);
                ...
                <div id="oolfm_lafm_url"><p class='lead'>
                    ...
                    <script type="text/html" id="description_template" charset="utf-8">
                        <%= "" + this.description +"<br><br>" + "<span id='thisstationname_about_lbl'>"+ this.display_name +"</span>" + " ist ein laut.fm user-generated-radio, erreichbar unter <a target='_blank' href='https://laut.fm/$lfmstream'>laut.fm/$lfmstream</a>" %>
                    </script>
                </p>
                <script type="text/javascript" charset="utf-8">
                    laut.fm.station('$lfmstream')
