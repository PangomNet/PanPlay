...
?></oop_div></a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#sendeplan_modal" href="#"><i class="fas fa-calendar-week"></i> Sendeplan</a></li>
        </li>
        <li class="nav-item">
            <a id="aboutsenderlink_lbl" class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#stationinfo_modal" href="#">Über ''</a></li>
        </li>
