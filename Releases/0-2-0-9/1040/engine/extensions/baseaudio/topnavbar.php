<nav id="topnavbar" class="navbar fixed-top navbar-expand-sm navbar-dark bg-dark">
  <div class="container-fluid">
       ...
       <i class="fas fa-music me-2" aria-hidden="true"></i><?php
    echo htmlspecialchars((string) ($baseaudioMetadata['title'] ?? $webstream), ENT_QUOTES | ENT_SUBSTITUTE, 'UTF-8');
?>
</oop_div>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav">
        <li class="nav-item">
            <a id="aboutsenderlink_lbl" class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#fileinfo_modal"><i class="fas fa-info-circle me-2" aria-hidden="true"></i><?php echo $ext_lang['stationinfo_navbar_title'] ?></a></li>
        </li>
...
//}
?>
<li><a class='nav-link' data-bs-toggle='modal' data-bs-target='#playwith_modal' href='#'><i class='far fa-play-circle me-2' aria-hidden='true'></i><?php echo $ext_lang['playwith_navbar_title']; ?></a></li>
          <li class='nav-item'>
