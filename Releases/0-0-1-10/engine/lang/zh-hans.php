...
'about_prerelease_warning_title' => '不稳定的预发布',
'about_prerelease_warning_p1' => '此版本的',
'about_prerelease_warning_p2' => '是一个预发布版本，仅用于跟踪开发进度。不推荐用于生产环境。',
'about_documentation_p1' => '有关更多信息，请访问',
'about_documentation_p2' => '文档页面',
