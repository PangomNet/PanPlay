...
// --- Player Identity ---
// First architecture test of the PWF-based PanPlay generation.
// PWF keeps its own independent version number; this build uses PWF 0.1.0-alpha.6.
