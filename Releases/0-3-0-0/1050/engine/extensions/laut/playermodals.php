...
<div class="modal fade" id="lastplayed_modal" tabindex="-1" aria-labelledby="lastplayed_modal" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen-md-down modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      ...
      <a class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#currentsong_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-music"></i> {$ext_lang["current_song_modallink"]}</a>
      <!--<a href="#" data-bs-toggle="modal" data-bs-target="#currentplaylist_modal" data-bs-dismiss="modal" target="_blank" >Current Show</a> -->
      <a id="lastplayed_modal__sendeplan_btn" style="display: none;" class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#sendeplan_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-calendar-week"></i> {$ext_lang["sendeplan_modal_title"]}</a>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="sendeplan_modal" tabindex="-1" aria-labelledby="sendeplan_modal" aria-hidden="true">
  <div class="modal-dialog modal-fullscreen-md-down modal-dialog-centered modal-dialog-scrollable">
    ...
    <div class="modal-body">
      ...
      <div class="modal-footer">
        <a id="sendeplan_modal__trackhistory_btn" style="display: none;" class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#lastplayed_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-history"></i>  {$ext_lang["trackhistory_navbar_title"]}</a> 
        <!--<a href="#" data-bs-toggle="modal" data-bs-target="#currentplaylist_modal" data-bs-dismiss="modal" target="_blank" >Current Show</a>-->
        <a id="sendeplan_modal__currentsong_btn"  class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#currentsong_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-music"></i> {$ext_lang["current_song_modallink"]}</a> 
...
<div class="modal fade" id="currentsong_modal" tabindex="-1" aria-labelledby="currentsong_modal" aria-hidden="true" style="display: none;">
  <div class="modal-dialog modal-fullscreen-md-down modal-dialog-centered modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="container" style="padding-top: 10px; padding-bottom: 10px;">
        ...
        <span id="currentsong_modal_artistat_applemusic_lbl">currentsong_modal_artistat_lastfm_lbl</span>
        ...
        <div class="modal-footer">
        <a id="currentsong_modal__trackhistory_btn" style="display: none;" class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#lastplayed_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-history"></i>  {$ext_lang["trackhistory_navbar_title"]}</a> 
        <!--<a href="#" data-bs-toggle="modal" data-bs-target="#currentplaylist_modal" data-bs-dismiss="modal" target="_blank" >Current Show</a>-->
        <a id="currentsong_modal__sendeplan_btn" style="display: none;" class="btn link-underline link-underline-opacity-0" href="#" data-bs-toggle="modal" data-bs-target="#sendeplan_modal" data-bs-dismiss="modal" target="_blank" ><i class="fas fa-calendar-week"></i> {$ext_lang["sendeplan_modal_title"]}</a>
        </div>
    </div>
  </div>
</div>
...
if ($sendeplan !== false) {
  ...
  echo "<style> #currentsong_modal__sendeplan_btn {display: inline !important;};</style>";
  echo "<style> #lastplayed_modal__sendeplan_btn {display: inline !important;};</style>";
}
if ($trackhistory !== false) {
  echo $lastplayed_modal_code;
  echo "<style> #currentsong_modal__trackhistory_btn {display: inline !important;};</style>";
  echo "<style> #sendeplan_modal__trackhistory_btn {display: inline !important;};</style>";
