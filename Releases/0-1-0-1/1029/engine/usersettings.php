...
<div class="card text-white bg-dark">
  ...
  <div class="card-body">
  <p class="card-text fs-6"><small>{$lang["settingspanel_lang_desc"]}  <br> <i class="fas fa-info"></i><i> {$lang["settingspanel_lang_ext_desc"]}</i></small></p>
...
foreach($available_languages as $lang_code => $lang_name) {
    ...
    $language_settings_code .= <<<HTML
        <a class="dropdown-item text-white bg-dark" href="{$lang_link}">
            {$lang_name}
        </a>
HTML;
}
