...
//basic
    ...
    //centralerrorlog
    'centralerrorlog_error_occured' => 'Mensaje de error de ejemplo al cargar la pÃ¡gina.',
    'centralerrorlog_neterror_occured' => 'Error de red al cargar ',
    'centralerrorlog_modal_title' => 'Consola de errores',
    'centralerrorlog_modal_desc' => 'Si tienes acceso a esta ventana, significa que han ocurrido errores crÃ­ticos (probablemente errores de conexiÃ³n). Estos errores podrÃ­an afectar el funcionamiento de "PanPlay" de forma leve o significativa, e incluso provocar un bloqueo. Por favor, presta atenciÃ³n. Si estÃ¡s familiarizado con las herramientas de desarrollo de tu dispositivo, te recomendamos buscar errores adicionales allÃ­. Es posible que los errores sean solucionables.',
    'centralerrorlog_occuring_modal_title' => 'Consola de errores',
    'centralerrorlog_occuring_modal_desc1' => 'Â¡Han ocurrido errores! Puede haber una pÃ©rdida de conexiÃ³n. Por favor, verifica la',
    ...
    'about_license_datewording' => 'en la versiÃ³n del',
    'about_prerelease_warning_title' => 'VersiÃ³n preliminar inestable',
    'about_prerelease_warning_p1' => 'Esta versiÃ³n de',
    'about_prerelease_warning_p2' => 'es una versiÃ³n preliminar destinada exclusivamente a seguir el progreso del desarrollo. No se recomienda su uso en producciÃ³n.',
    'about_documentation_p1' => 'Para obtener mÃ¡s informaciÃ³n, consulta la',
    'about_documentation_p2' => 'documentaciÃ³n',
    'about_documentation_p3' => '.',
    'about_legal_p1' => 'Se aplican los',
    'about_legal_p2' => 'privacidad',
    'about_legal_p3' => 'y el ',
    'about_legal_p4' => 'Aviso legal',
    'about_legal_p5' => '. TambiÃ©n se aplican los',
    'about_legal_p6' => 'TÃ©rminos de uso',
    'about_legal_p7' => 'que puedes ',
    'about_legal_p8' => 'encontrar aquÃ­',
    'about_legal_p9' => '.',
