...
//basic
    ...
    'stationinfo_navbar_title' => ' Info sul File',
    ...
    'sendeplan_laut' => 'Il palinsesto completo su laut.fm',

    //Stationinfo modal
    'stationinfo_modal_title' => 'Info sul File',
    'stationinfo_modal_topdesc' => 'Al momento non è possibile trovare ulteriori dettagli sul file. Per questo si dovrà attendere lo sviluppo di oOPlay. La lettura dei file è prevista per il futuro. Tuttavia, non è ancora stata implementata',

    //playwith modal
    'playwith_modal_title' => 'Cambia giocatore',
    'playwith_modal_topdesc' => 'È possibile aprire questo flusso in altri servizi o dispositivi di riproduzione esterni. A tal fine, selezionare l&#39;opzione di riproduzione corrispondente.',
    'playwith_modal_gcast_topdesc1' => 'Trasferimento "',
    'playwith_modal_gcast_topdesc2' => '" a un dispositivo che supporta Chromecast o Casting di Google. A tal fine, fare clic sull&#39;icona Google Cast in basso a destra della schermata principale. (<i class="fab fa-chromecast"></i>)**',
    'directstreamtobrowserdropdown' => 'Aprire l&#39;URL del ruscello',
    'directstreamtobrowserdropdown_option1' => '<span class="badge bg-dark">m3u</span> Aprire / Scaricare',
    'directstreamtobrowserdropdown_option2' => '<span class="badge bg-dark">pls</span> Aprire / Scaricare',
    'playwith_modal_bottomnote' => '* Se si utilizza un&#39;applicazione finale del servizio selezionato sul proprio dispositivo (ad esempio, l&#39;applicazione laut.fm su Android), questa potrebbe intercettare la navigazione verso questo servizio. Il flusso verrà quindi aperto direttamente nella rispettiva applicazione.',
